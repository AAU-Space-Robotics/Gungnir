...
{
  RCLCPP_INFO(logger_, "Joint velocity commands: %f, %f, %f, %f, %f, %f",
    joint_velocities_command_[0], joint_velocities_command_[1], joint_velocities_command_[2],
    joint_velocities_command_[3], joint_velocities_command_[4], joint_velocities_command_[5]);

  actuator.sendVelocitySetpoint(joint_velocities_command_[5]*10);
  return return_type::OK;
}
